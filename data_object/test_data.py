...
# test workload simple data
class TestWorkloadSimpleData(db.Model):
...
class TestWorkloadSimpleDataSchema(ma.ModelSchema):
    class Meta:
        model = TestWorkloadSimpleData


# test workload complex data
class TestWorkloadComplexData(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    code = db.Column(db.String(10))
...
class TestWorkloadComplexDataSchema(ma.ModelSchema):
    class Meta:
        model = TestWorkloadComplexData
